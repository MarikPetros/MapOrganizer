...
public class NotificationAlarmReceiver extends BroadcastReceiver {
    ...
    public static final String TIMED_NOTIFICATION_CHANNEL_ID = "timed_notifications";
    ...
    public void onReceive(Context context, Intent intent) {
       ...
       /* if(date == null){
        ...
        NotificationCompat.Builder mSummaryBuilder = new NotificationCompat.Builder(context, TIMED_NOTIFICATION_CHANNEL_ID)
