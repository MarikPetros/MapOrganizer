...
//
//import com.example.marik.maporganizer.BuildConfig;
...
//
//
//public class ImagePicker implements WriteBitmapToFileTask.OnResultListener{
//
...
//            takePhotoIntent.putExtra("return-data", selectedImageUri);
//
//        }
////        takePhotoIntent.putExtra(MediaStore.EXTRA_OUTPUT, Uri.fromFile(getTempFile(context)));
////        takePhotoIntent.putExtra(MediaStore.EXTRA_OUTPUT, FileProvider.getUriForFile(context,
////                BuildConfig.APPLICATION_ID + ".provider", getTempFile(context)));
...
//                    imageReturnedIntent.getData().toString().contains(photoFile.toString()));
//
//            if (isCamera) {     /** CAMERA **/
////                selectedImageUri = Uri.fromFile(imageFile);
//                if (photoFile != null) {
//                    selectedImageUri = FileProvider.getUriForFile(context,
//                        "com.example.marik.maporganizer.fileprovider",
//                        photoFile);}
//            } else {            /** ALBUM **/
